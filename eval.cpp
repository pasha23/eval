...
int main(int argc, char **argv, char **envp)
{
    ...
    acosa         = define_funct(atomize("acos"), 1, (void*)acosff);
    alphapa       = define_funct(atomize("char-alphabetic?"), 1, (void*)alphap);
    ampera        = define_funct(atomize("&"), 0, (void*)andf);
    anglea        = define_funct(atomize("angle"), 1, (void*)angle);
    appenda       = define_funct(atomize("append"), 2, (void*)append);
    applya        = define_funct(atomize("apply"), 2, (void*)apply);
    asina         = define_funct(atomize("asin"), 1, (void*)asinff);
    atana         = define_funct(atomize("atan"), 1, (void*)atanff);
    atomsa        = define_funct(atomize("atoms"), 0, (void*)atomsf);
    booleanpa     = define_funct(atomize("boolean?"), 1, (void*)booleanp);
    callwithina   = define_funct(atomize("call-with-input-file"), 2, (void*)callwithin);
    callwithouta  = define_funct(atomize("call-with-output-file"), 2, (void*)callwithout);
    ceilinga      = define_funct(atomize("ceiling"), 1, (void*)ceilingff);
    char2ia       = define_funct(atomize("char->integer"), 1, (void*)char2int);
    charcieqa     = define_funct(atomize("char-ci=?"), 2, (void*)charcieq);
    charcigea     = define_funct(atomize("char-ci>=?"), 2, (void*)charcige);
    charcigta     = define_funct(atomize("char-ci>?"), 2, (void*)charcigt);
    charcilea     = define_funct(atomize("char-ci<=?"), 2, (void*)charcile);
    charcilta     = define_funct(atomize("char-ci<?"), 2, (void*)charcilt);
    chareqa       = define_funct(atomize("char=?"), 2, (void*)chareq);
    chargea       = define_funct(atomize("char>=?"), 2, (void*)charge);
    chargta       = define_funct(atomize("char>?"), 2, (void*)chargt);
    charlea       = define_funct(atomize("char<=?"), 2, (void*)charle);
    charlta       = define_funct(atomize("char<?"), 2, (void*)charlt);
    charpa        = define_funct(atomize("char?"), 1, (void*)charp);
    clinporta     = define_funct(atomize("close-input-port"), 1, (void*)clinport);
    closurepa     = define_funct(atomize("closure?"), 1, (void*)closurep);
    cloutporta    = define_funct(atomize("close-output-port"), 1, (void*)cloutport);
    complexpa     = define_funct(atomize("complex?"), 1, (void*)complexp);
    cosa          = define_funct(atomize("cos"), 1, (void*)cosff);
    curinporta    = define_funct(atomize("current-input-port"), 0, (void*)curinport);
    curoutporta   = define_funct(atomize("current-output-port"), 0, (void*)curoutport);
    cyclicpa      = define_funct(atomize("cyclic?"), 1, (void*)cyclicp);
    displaya      = define_funct(atomize("display"), 0, (void*)displayf);
    downcasea     = define_funct(atomize("char-downcase"), 1, (void*)downcase);
    e2ia          = define_funct(atomize("exact->inexact"), 1, (void*)e2if);
    eofobjp       = define_funct(atomize("eof-object?"), 1, (void*)eofp);
    evala         = define_funct(atomize("eval"), 2, (void*)eval);
    exactpa       = define_funct(atomize("exact?"), 1, (void*)exactp);
    expa          = define_funct(atomize("exp"), 1, (void*)expff);
    floora        = define_funct(atomize("floor"), 1, (void*)floorff);
    forcea        = define_funct(atomize("force"), 1, (void*)force);
    forcedpa      = define_funct(atomize("promise-forced?"), 1, (void*)forcedp);
    gca           = define_funct(atomize("gc"), 0, (void*)gc);
    gcda          = define_funct(atomize("gcd"), 2, (void*)gcdf);
    i2ea          = define_funct(atomize("inexact->exact"), 1, (void*)i2ef);
    inexactpa     = define_funct(atomize("inexact?"), 1, (void*)inexactp);
    inportpa      = define_funct(atomize("input-port?"), 1, (void*)inportp);
    int2chara     = define_funct(atomize("integer->char"), 1, (void*)int2char);
    integerpa     = define_funct(atomize("integer?"), 1, (void*)integerp);
    lcma          = define_funct(atomize("lcm"), 2, (void*)lcmf);
    list2sa       = define_funct(atomize("list->string"), 1, (void*)list2s);
    list2vector   = define_funct(atomize("list->vector"), 1, (void*)list2vec);
    listpa        = define_funct(atomize("list?"), 1, (void*)listp);
    loada         = define_funct(atomize("load"), 1, (void*)load);
    loga          = define_funct(atomize("log"), 1, (void*)logff);
    lowercasepa   = define_funct(atomize("char-lower-case?"), 1, (void*)lowercasep);
    lsha          = define_funct(atomize("<<"), 2, (void*)lsh);
    magnitudea    = define_funct(atomize("magnitude"), 1, (void*)magnitude);
    makestringa   = define_funct(atomize("make-string"), 0, (void*)makestring);
    makevector    = define_funct(atomize("make-vector"), 0, (void*)makevec);
    newlinea      = define_funct(atomize("newline"), 0, (void*)newlinef);
    num2stringa   = define_funct(atomize("number->string"), 1, (void*)number2string);
    numberpa      = define_funct(atomize("number?"), 1, (void*)numberp);
    numericpa     = define_funct(atomize("char-numeric?"), 1, (void*)numericp);
    openina       = define_funct(atomize("open-input-file"), 1, (void*)openin);
    openouta      = define_funct(atomize("open-output-file"), 1, (void*)openout);
    outportpa     = define_funct(atomize("output-port?"), 1, (void*)outportp);
    peekchara     = define_funct(atomize("peek-char"), 0, (void*)peekchar);
    pipea         = define_funct(atomize("|"), 0, (void*)orf);
    powa          = define_funct(atomize("pow"), 2, (void*)powff);
    procedurepa   = define_funct(atomize("procedure?"), 1, (void*)procedurep);
    promisepa     = define_funct(atomize("promise?"), 1, (void*)promisep);
    promiseva     = define_funct(atomize("promise-value"), 1, (void*)promisev);
    rationalpa    = define_funct(atomize("rational?"), 1, (void*)rationalp);
    reada         = define_funct(atomize("read"), 0, (void*)readf);
    readchara     = define_funct(atomize("read-char"), 0, (void*)readchar);
    readypa       = define_funct(atomize("char-ready?"), 0, (void*)readyp);
    realpa        = define_funct(atomize("real?"), 1, (void*)realp);
    reversea      = define_funct(atomize("reverse"), 1, (void*)reverse);
    rounda        = define_funct(atomize("round"), 1, (void*)roundff);
    rsha          = define_funct(atomize(">>"), 2, (void*)rsh);
    s2lista       = define_funct(atomize("string->list"), 1, (void*)s2list);
    s2numa        = define_funct(atomize("string->number"), 1, (void*)s2num);
    setcara       = define_funct(atomize("set-car!"), 2, (void*)setcarf);
    setcdra       = define_funct(atomize("set-cdr!"), 2, (void*)setcdrf);
    sina          = define_funct(atomize("sin"), 1, (void*)sinff);
    spacea        = define_funct(atomize("space"), 0, (void*)spacef);
    sqrta         = define_funct(atomize("sqrt"), 1, (void*)sqrtff);
    stringa       = define_funct(atomize("string"), 0, (void*)string);
    stringappenda = define_funct(atomize("string-append"), 2, (void*)stringappend);
    stringcieq    = define_funct(atomize("string-ci=?"), 2, (void*)stringcieqf);
    stringcige    = define_funct(atomize("string-ci>=?"), 2, (void*)stringcigef);
    stringcigt    = define_funct(atomize("string-ci>?"), 2, (void*)stringcigtf);
    stringcile    = define_funct(atomize("string-ci<=?"), 2, (void*)stringcilef);
    stringcilt    = define_funct(atomize("string-ci<?"), 2, (void*)stringciltf);
    stringcopy    = define_funct(atomize("string-copy"), 1, (void*)stringcopyf);
    stringeq      = define_funct(atomize("string=?"), 2, (void*)stringeqf);
    stringfill    = define_funct(atomize("string-fill!"), 2, (void*)stringfillf);
    stringge      = define_funct(atomize("string>=?"), 2, (void*)stringgef);
    stringgt      = define_funct(atomize("string>?"), 2, (void*)stringgtf);
    stringle      = define_funct(atomize("string<=?"), 2, (void*)stringlef);
    stringlength  = define_funct(atomize("string-length"), 1, (void*)stringlengthf);
    stringlt      = define_funct(atomize("string<?"), 2, (void*)stringltf);
    stringpa      = define_funct(atomize("string?"), 1, (void*)stringp);
    stringref     = define_funct(atomize("string-ref"), 2, (void*)stringreff);
    stringset     = define_funct(atomize("string-set!"), 3, (void*)stringsetf);
    substringa    = define_funct(atomize("substring"), 0, (void*)substringf);
    sy2sa         = define_funct(atomize("symbol->string"), 1, (void*)sy2s);
    symbolpa      = define_funct(atomize("symbol?"), 1, (void*)symbolp);
    tana          = define_funct(atomize("tan"), 1, (void*)tanff);
    tilde         = define_funct(atomize("~"), 1, (void*)complement);
    tracea        = define_funct(atomize("trace"), 1, (void*)trace);
    truncatea     = define_funct(atomize("truncate"), 1, (void*)truncateff);
    upcasea       = define_funct(atomize("char-upcase"), 1, (void*)upcase);
    uppercasepa   = define_funct(atomize("char-upper-case?"), 1, (void*)uppercasep);
    vec2lista     = define_funct(atomize("vector->list"), 1, (void*)vec2list);
    vectora       = define_funct(atomize("vector"), 0, (void*)vector);
    vectorfill    = define_funct(atomize("vector-fill!"), 2, (void*)vecfill);
    vectorlength  = define_funct(atomize("vector-length"), 1, (void*)veclength);
    vectorpa      = define_funct(atomize("vector?"), 1, (void*)vectorp);
    vectorref     = define_funct(atomize("vector-ref"), 2, (void*)vecref);
    vectorset     = define_funct(atomize("vector-set!"), 3, (void*)vecset);
    whitespacepa  = define_funct(atomize("char-whitespace?"), 1, (void*)whitespacep);
    withina       = define_funct(atomize("with-input-from-file"), 2, (void*)within);
    withouta      = define_funct(atomize("with-output-to-file"), 2, (void*)without);
    writea        = define_funct(atomize("write"), 0, (void*)writef);
    writechara    = define_funct(atomize("write-char"), 0, (void*)writechar);
    xora          = define_funct(atomize("^"), 0, (void*)xorf);
    nullpa        = define_funct(atomize("null?"), 1, (void*)nullp);
    pairpa        = define_funct(atomize("pair?"), 1, (void*)pairp);
    negativepa    = define_funct(atomize("negative?"), 1, (void*)negativep);
    positivepa    = define_funct(atomize("positive?"), 1, (void*)positivep);
    percent       = define_funct(atomize("%"), 0, (void*)unimod);
    slash         = define_funct(atomize("/"), 0, (void*)unidiv);
    nota          = define_funct(atomize("not"), 1, (void*)isnot);
    nega          = define_funct(atomize("neg"), 1, (void*)negf);
    lta           = define_funct(atomize("<"), 2, (void*)lt);
    lea           = define_funct(atomize("<="), 2, (void*)le);
    gea           = define_funct(atomize(">="), 2, (void*)ge);
    gta           = define_funct(atomize(">"), 2, (void*)gt);
    eqa           = define_funct(atomize("eq?"), 2, (void*)eqp);
    eqna          = define_funct(atomize("="), 2, (void*)eqnp);
    equalpa       = define_funct(atomize("equal?"), 2, (void*)equalp);
    eqva          = define_funct(atomize("eqv?"), 2, (void*)eqv);
    plus          = define_funct(atomize("+"), 0, (void*)uniadd);
    minus         = define_funct(atomize("-"), 0, (void*)unisub);
    star          = define_funct(atomize("*"), 0, (void*)unimul);
    cara          = define_funct(atomize("car"), 1, (void*)car);
    cdra          = define_funct(atomize("cdr"), 1, (void*)cdr);
    consa         = define_funct(atomize("cons"), 2, (void*)cons);

    begin         = define_form(atomize("begin"), beginform);
    boundpa       = define_form(atomize("bound?"), boundp);
    cond          = define_form(atomize("cond"), condform);
    definea       = define_form(atomize("define"), defineform);
    delaya        = define_form(atomize("delay"), delayform);
    doa           = define_form(atomize("do"), doform);
    intenva       = define_form(atomize("interaction-environment"), intenvform);
    nulenva       = define_form(atomize("null-environment"), nulenvform);
    let           = define_form(atomize("let"), letform);
    letstar       = define_form(atomize("let*"), letstarform);
    letrec        = define_form(atomize("letrec"), letrecform);
    quasiquote    = define_form(atomize("quasiquote"), quasiquoteform);
    seta          = define_form(atomize("set!"), setform);
    whilea        = define_form(atomize("while"), whileform);
    anda          = define_form(atomize("and"), andform);
    ora           = define_form(atomize("or"), orform);
    ifa           = define_form(atomize("if"), ifform);
    quote         = define_form(atomize("quote"), quoteform);
    lambda        = define_form(atomize("lambda"), lambdaform);
    complexa      = define_form(atomize("complex"), complexform);
    rationala     = define_form(atomize("rational"), rationalform);
